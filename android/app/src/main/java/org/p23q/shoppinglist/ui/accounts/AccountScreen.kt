...
fun AccountScreen(
    ...
    Column(modifier = Modifier.fillMaxSize().verticalScroll(rememberScrollState()).padding(16.dp)) {
        ...
        when (account?.status()) {
            AccountStatus.SIGNED_OUT -> TextButton(onClick = onSignIn, modifier = Modifier.testTag("account-sign-in")) {
        ...
        // Filled red (T-112): deleting on the server is final. Confirmation still gates it.
        Button(
