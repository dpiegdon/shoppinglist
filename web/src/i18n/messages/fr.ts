...
export const fr: Catalog = {
  ...
  "apiError.notFound": "Le serveur ne connaît pas cette requête.",
  "apiError.methodNotAllowed": "Le serveur ne connaît pas cette requête.",
  "apiError.internalError": "Une erreur est survenue",
