...
export const ja: Catalog = {
  ...
  "overview.kind.expenses": "共同の支出。誰が払い、誰が払うのかを記録します。",
  "overview.currencyHelp": "このリストのすべての支出に使われ、作成後は変更できません。",
  "listProps.kind.expenses": "共同の支出と、メンバーごとの残高。",
  "listProps.kindFixed": "支出リストの種類と通貨はあとから変更できません。",
  "expense.currency": "通貨",
  "expense.what": "内容",
  "expense.total": "合計",
  "expense.date": "日付",
  ...
  "expense.deleteBlocked": "この支出は削除できません：金額が確定している人が関わっています。",
};
