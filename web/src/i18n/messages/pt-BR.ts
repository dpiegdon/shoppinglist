...
export const ptBR: Catalog = {
  ...
  "apiError.notFound": "O servidor não reconhece esta solicitação.",
  "apiError.methodNotAllowed": "O servidor não reconhece esta solicitação.",
  "apiError.internalError": "Algo deu errado",
