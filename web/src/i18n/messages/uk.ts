...
export const uk: Catalog = {
  ...
  "expense.closingHelp": "Мають погодитися всі. Щойно ви погодитеся, ви більше не зможете додавати витрати, і нічого, що стосується вас, уже не можна додати чи змінити. Після закриття список стає записом лише для читання, і його можна залишити.",
  ...
  "apiError.votedToClose": "Ви погодилися закрити цей список, тому не можете додавати витрати. Відкличте свою згоду, щоб додати.",
};
