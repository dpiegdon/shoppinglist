...
export const uk: Catalog = {
  ...
  "expense.closingHelp": "Мають погодитися всі. Щойно ви погодитеся, ваші суми буде зафіксовано: нічого, що стосується вас, уже не можна додати чи змінити. Після закриття список стає записом лише для читання, і його можна залишити.",
