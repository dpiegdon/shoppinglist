...
export const uk: Catalog = {
  ...
  "listKind.expenses": "Витрати",
  "overview.kind.expenses": "Спільні витрати: хто заплатив і хто винен.",
  "overview.currencyHelp": "Використовується для кожної витрати в цьому списку й далі не змінюється.",
  "listProps.kind.expenses": "Спільні витрати з балансом для кожного учасника.",
  "listProps.kindFixed": "Список витрат назавжди зберігає свій тип і валюту.",
  ...
  "expense.deleteBlocked": "Цю витрату не можна видалити: вона стосується когось, чиї суми зафіксовано.",
};
