...
export const zhHans: Catalog = {
  ...
  "admin.users": "用户",
  "admin.showUsers": "显示注册用户",
  "admin.userCount": "注册用户：{count}",
  ...
  "listKind.expenses": "账本",
  "overview.kind.expenses": "共同的钱：谁付的、谁收的、谁欠谁。",
  "overview.currencyHelp": "用于此清单的每一笔记录，创建后不可更改。",
  "listProps.kind.expenses": "共同的钱，并显示每位成员的余额。",
  "listProps.kindFixed": "账本的类型和货币始终不可更改。",
  "expense.currency": "货币",
  "expense.what": "事由",
  "expense.total": "合计",
  "expense.date": "日期",
  ...
  "expense.type.transfer": "转账",
  "expense.paidBy": "付款人",
  "expense.paidFor": "分摊给",
  "expense.receivedBy": "收款人",
  "expense.creditedTo": "计入",
  "expense.from": "付款方",
  "expense.to": "收款方",
  "expense.new": "新建记录",
  "expense.edit": "编辑记录",
  "expense.add": "添加记录",
  "expense.empty": "还没有记录。添加一笔开始吧。",
  "expense.balances": "余额",
  "expense.entries": "记录",
  "expense.totalSpent": "净支出",
  "expense.yourBalance": "你的余额",
  "expense.paidAndShare": "已付 {paid} · 分摊 {share}",
  "expense.paidShareSettled": "已付 {paid} · 分摊 {share} · 结算 {settled}",
  "expense.spentBreakdown": "支出 {spent} · 收入 {income}",
  "expense.formerMember": "已退出的成员 {number}",
  "expense.forEveryone": "所有人",
  "expense.rowBy": "由 {by} 支付 · 给 {for}",
  "expense.rowReceivedBy": "由 {by} 收款 · 给 {for}",
  ...
  "expense.error.sameMember": "请选择两位不同的成员。",
  "expense.error.needTwoMembers": "转账需要此清单中的两位不同成员。",
  ...
  "listProps.leaveBlocked": "账本结算后才能退出。",
  ...
  "apiError.invalidExpense": "该记录无效",
  "apiError.invalidField": "该值无效",
  "apiError.invalidStatus": "该状态无效",
  "apiError.invalidDeviceLabel": "设备名称太长了",
  ...
  "apiError.cannotDeleteExpenseList": "账本无法删除。请先结算，再退出。",
  ...
  "apiError.notFound": "服务器无法识别此请求。",
  "apiError.methodNotAllowed": "服务器无法识别此请求。",
  "apiError.internalError": "出错了",
